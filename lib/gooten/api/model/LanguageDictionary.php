...
use \ArrayAccess;
/**
 * LanguageDictionary Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     gooten.api.client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LanguageDictionary implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        'category' => 'string',
        'values' => '\gooten.api.model\KeyValuePair[]'
    );
    ...
    /**
      * $values 
      * @var \gooten.api.model\KeyValuePair[]
      */
    protected $values;
    ...
    /**
     * Gets values
     * @return \gooten.api.model\KeyValuePair[]
     */
    ...
    /**
     * Sets values
     * @param \gooten.api.model\KeyValuePair[] $values 
     * @return $this
     */
