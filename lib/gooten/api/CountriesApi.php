...
class CountriesApi
{
     ...
     * @return \gooten.api.model\CountryList
     ...
     * @param string $language_code Two-character language code, like \&quot;en\&quot; (english) (optional)
     * @param string $key A string used to query the language dictionary for specific values within a category. (optional)
     * @return Array of \gooten.api.model\CountryList, HTTP status code, HTTP response headers (array of strings)
     * @throws \gooten.api.client\ApiException on non-2xx response
     */
    public function countriesWithHttpInfo($language_code = null, $key = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\gooten.api.model\CountryList'
            );
            ...
            return array(\gooten.api.client\ObjectSerializer::deserialize($response, '\gooten.api.model\CountryList', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \gooten.api.client\ObjectSerializer::deserialize($e->getResponseBody(), '\gooten.api.model\CountryList', $e->getResponseHeaders());
